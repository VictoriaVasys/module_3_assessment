...
feature "as a user, I should be able to search for best buy stores" do
  scenario "by zipcode" do
    ...
    within first(".store") do
      expect(page).to have_selector(".store_long_name")
      expect(page).to have_selector(".store_city")
      expect(page).to have_selector(".store_distance")
      expect(page).to have_selector(".store_phone")
